...
<div class="clearfix content" id="main-content">
	 	...
	 	<c:forEach items="${listLands }" var="itemLand">
		     <div class="clearfix single_content">
		         ...
		         <div class="clearfix post_detail">
		             ...
		             <h2><a href="${urlDetail }">${itemLand.name }. </a></h2>
		             <div class="clearfix post-meta"><% %>
		                 <p>
		                 	<span><i class="fa fa-home"></i> Địa chỉ:${StringUtil.getText(itemLand.address, 68)}</span> 
		                 	<span class="text-normal">
				        		<i class="fa fa-folder"></i> Diện tích: ${itemLand.area} m<sup>2</sup>
				        		<i class="fa fa-eye"></i> Lượt xem: ${itemLand.views}
				        	</span>
		             </div>
		             ...
		             <a class="hvr-wobble-horizontal" href="${urlDetail }">Đọc thêm</a>
		         </div>
		     </div>	
	 	</c:forEach>
	 </c:if>
     ...
     <nav>
        <ul>
        	<c:if test="${numberOfPages > 0 }">
	        	...
	        	<c:if test="${page != 1 }">
	        		<li><a href="${pageContext.request.contextPath}/page-${page-1}"> <i class="glyphicon glyphicon-chevron-left"></i> </a></li>
	        	</c:if>
	        		...
	        		<c:forEach items="${paginations }" var="itemPagination">
	        			<c:choose>
	        				...
	        				<c:when test="${itemPagination == page }">
       						...
       						<c:otherwise>
       							<li><a href="${pageContext.request.contextPath}/page-${itemPagination}"> ${itemPagination } </a></li>
       						</c:otherwise>
	        			</c:choose>
	        		</c:forEach>
	        	</c:if>
	        	...
	        	<c:if test="${page != numberOfPages }">
	        		<li><a href="${pageContext.request.contextPath}/page-${page + 1}"> <i class="glyphicon glyphicon-chevron-right"></i> </a></li>
	        	</c:if>
        	</c:if>
        </ul>
     </nav>
