...
<div class="row">
	...
	<form action="${pageContext.request.contextPath }/admin/slide/edit/${objSlide.id}-${page}" method="post" enctype="multipart/form-data">
                 ...
                 <div>
                     ...
                     <div class="row">
                         <div class="col-sm-6">
                             ...
                             <img class="img-thumbnail" style="width: 200px" src="${pageContext.request.contextPath }/files/${objSlide.picture }" />
