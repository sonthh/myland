...
<div class="row">
        ...
        <table class="table table-striped table-bordered" id="example">
            ...
            <tbody>
            	<c:choose>
            		...
            		<c:otherwise>
            			<tr class="odd gradeX"><td colspan="10">Không có lands nào</td></tr>
            		</c:otherwise>
            	</c:choose>
            </tbody>
        </table>
    ...
    <nav class="text-center" aria-label="...">
        <ul class="pagination">
        	...
        	<c:if test="${page != 1 }">
        		 <li class=""><a href="${pageContext.request.contextPath}/admin/land/page-${page-1}" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
        	</c:if>
        		...
        		<c:forEach items="${paginations }" var="itemPagination">
        			<c:choose>
        				<c:when test="${itemPagination == page }">
        					<li class="active"><a href="${pageContext.request.contextPath}/admin/land/page-${itemPagination}">${itemPagination } <span class="sr-only">(current)</span></a></li>
        				</c:when>
    					...
    					<c:otherwise>
    						<li><a href="${pageContext.request.contextPath}/admin/land/page-${itemPagination}">${itemPagination }</a></li>
    					</c:otherwise>
    				</c:choose>
        		</c:forEach>
        	</c:if>
        	...
        	<c:if test="${page != numberOfPages }">
        		 <li><a href="${pageContext.request.contextPath}/admin/land/page-${page + 1}" aria-label="Next"><span aria-hidden="true">»</span></a></li>
        	</c:if>
        </ul>
    </nav>
    <!-- /.pagination -->
