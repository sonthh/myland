                     ...
                     <div class="row">
                         <div class="col-sm-6">
                             <div class="form-group">
                                 ...
                                 <input readonly="readonly" type="text" id="username" name="username" value="${objUser.username }" class="form-control" placeholder="Nhập username">
                             </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="password" id="password" name="password" value="" class="form-control" placeholder="Nhập password">
                             </div>
